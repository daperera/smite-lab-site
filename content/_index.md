...
<div class="hero">
    <img src="img/smite-logo-tag-1-cinza@2x.png" alt="SMITE Lab Logo">
</div>


## About {#about}

Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam porttitor eget massa quis interdum. Curabitur pulvinar hendrerit ante. Nam est felis, venenatis id elit vitae, tincidunt laoreet felis. In bibendum odio sem, id elementum ex venenatis vel. Nunc vehicula urna at scelerisque pellentesque. Proin vel risus sagittis, tincidunt lectus ut, scelerisque mi. Vivamus vel erat non est blandit iaculis. Nulla ac nibh sed mi varius pharetra. In velit nisi, scelerisque id interdum nec, auctor at erat. Maecenas dapibus nulla lacus, sit amet cursus odio bibendum eget. Integer molestie massa ut massa finibus, ac fringilla lorem efficitur. Duis vitae quam eget orci fringilla rutrum ut pulvinar mi.


## News {#news}

- **2026-02** — The extended version of the paper *Carcara: An efficient proof checker and elaborator for SMT proofs in the Alethe format* has been accepted to the STTT special issue on selected papers from TACAS'23.

- **2025-12** — Our paper *Hint-Based SMT Proof Reconstruction* has been accepted at TACAS'26.
...
- **2025-05** — Our paper on the reconstruction of cvc5 Alethe proofs in Isabelle/HOL has been accepted at ITP'25.

- **2025-04** — Our paper on the Lean-SMT project has been accepted at CAV'25.
...
- **2024-04** — Kick-off of the DARPA-funded project: *PEGISUS - Proof EnGineering and Integration with Satisfiability modUlo theorieS*.

- **2024-01** — The paper on IsaRare will appear at TACAS'24.

- **2023-10** — Our article *Generating and Exploiting Automated Reasoning Proof Certificates* was published in the *Communications of the ACM*.

- **2023-09** — Tomaz Mascarenhas has successfully defended his MSc thesis. Congratulations, Tomaz!

- **2023-04** — The paper *An Interactive SMT Tactic in Coq using Abductive Reasoning* will appear at LPAR'23.

- **2023-01** — The paper on Carcara will appear at TACAS'23.
...
- **2025**
  - *Improving the SMT Proof Reconstruction Pipeline in Isabelle/HOL*  
    Hanna Lachnitt, Mathias Fleury, Haniel Barbosa, et al.  
    In *ITP 2025*.
...
- **2024**
  - *Satisfiability Modulo Theories: A Beginner's Tutorial*  
    Clark Barrett, Cesare Tinelli, Haniel Barbosa, et al.  
    In *FM 2024* (Tutorial Track).
  ...
  - *IsaRare: Automatic Verification of SMT Rewrites in Isabelle/HOL*  
    Hanna Lachnitt, Mathias Fleury, Leni Aniva, et al.  
    In *TACAS 2024*, Springer.
...
- **2023**
  - *Generating and Exploiting Automated Reasoning Proof Certificates*  
    Haniel Barbosa, Clark Barrett, Byron Cook, et al.  
    In *Communications of the ACM*, 2023.

  - *Challenges in SMT Proof Production and Checking for Arithmetic Reasoning*  
    Haniel Barbosa  
    In *SC-Square@ISSAC 2023*.

  - *An Interactive SMT Tactic in Coq using Abductive Reasoning*  
    Haniel Barbosa, Chantal Keller, Andrew Reynolds, et al.  
    In *LPAR 2023*.
  ...
  - *Carcara: An efficient proof checker and elaborator for SMT proofs in the Alethe format*  
    ...
    In *TACAS 2023*, Springer.

  - *Synthesising Programs with Non-trivial Constants*  
    Alessandro Abate, Haniel Barbosa, Clark Barrett, et al.  
    In *Journal of Automated Reasoning*, 2023.

  - *7th SC-Square Workshop (SC-Square@FLoC 2022)*  
    Ali Kemal Uncu, Haniel Barbosa (eds.)  
    CEUR 3458, 2023.

- **2022**
  - *Reconstructing Fine-Grained Proofs of Complex Rewrites Using a Domain-Specific Language*  
    Andres Nötzli, Haniel Barbosa, et al.  
    In *FMCAD 2022*.

  - *Even Faster Conflicts and Lazier Reductions for String Solvers*  
    Andres Nötzli, Andrew Reynolds, Haniel Barbosa, et al.  
    In *CAV 2022*.

  - *Flexible Proof Production in an Industrial-Strength SMT Solver*  
    Haniel Barbosa, Andrew Reynolds, Gereon Kremer, et al.  
    In *IJCAR 2022*.

  - *cvc5: A Versatile and Industrial-Strength SMT Solver*  
    Haniel Barbosa, Clark Barrett, Martin Brain, et al.  
    In *TACAS 2022*.

- **2021**
  - *On-Line Synthesis of Parsers for String Events*  
    João Saffran, Haniel Barbosa, et al.  
...
- **2020**
  - *Scalable Algorithms for Abduction via Enumerative Syntax-Guided Synthesis*  
    Andrew Reynolds, Haniel Barbosa, et al.  
    In *IJCAR 2020*.
  ...
  - *Lifting congruence closure with free variables to lambda-free higher-order logic via SAT encoding*  
    Sophie Tourret, Pascal Fontaine, et al.  
    In *SMT@IJCAR*.
...
- **2019**
  - *Extending enumerative function synthesis via SMT-driven classification*  
    Haniel Barbosa, Andrew Reynolds, et al.  
    In *FMCAD 2019*.
  ...
  - *Sixth Workshop on Proof eXchange for Theorem Proving (PxTP 2019)*  
    Giselle Reis, Haniel Barbosa (eds.)
  ...
  - *Syntax-Guided Rewrite Rule Enumeration for SMT Solvers*  
    Andres Nötzli, Andrew Reynolds, et al.  
    In *SAT 2019*.

  - *Better SMT proofs for easier reconstruction*  
    Haniel Barbosa, Jasmin Blanchette, et al.  
    In *AITP 2019*.
